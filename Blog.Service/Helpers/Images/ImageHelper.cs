...
namespace Blog.Service.Helpers.Images
{
    public class ImageHelper : IImageHelper
    {
        ...
        {
            this.env = env;
            wwwroot = env.WebRootPath; //wwroota geldiğimde artık wwrootdaki path'e yönlendirmesi için 


        }
        private string ReplaceInvalidChars(string fileName) //klaveyedeki bilinmeyen harfler için bir replace işlemi düzenler
        {
